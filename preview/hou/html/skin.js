...
// Filename: skin_03.ggsk
// Generated 周二 12月 24 17:16:15 2013
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._tt_zoomin_white.innerHTML="\u524d\u8fdb";
		...
		this._tt_zoomout_white.innerHTML="\u540e\u9000";
		...
		this._tt_autorotate.innerHTML="\u5f00\u59cb\/\u505c\u6b62 \u81ea\u52a8\u65cb\u8f6c";
		...
		this._tt_autorotate_white.innerHTML="\u5f00\u59cb\/\u505c\u6b62 \u81ea\u52a8\u65cb\u8f6c";
		...
		this._tt_movemode.innerHTML="\u6539\u53d8\u63a7\u5236\u6a21\u5f0f";
		...
		this._tt_movemode_white.innerHTML="\u6539\u53d8\u63a7\u5236\u6a21\u5f0f";
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		
		{
			...
			this._swf_38=document.createElement('div');
			this._swf_38.ggId='SWF 38';
			this._swf_38.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._swf_38.ggVisible=true;
			this._swf_38.className='ggskin ggskin_swf';
			hs ='position:absolute;';
			hs+='left: -7px;';
			hs+='top:  -7px;';
			hs+='width: 15px;';
			...
			hs+=cssPrefix + 'transform-origin: 50% 50%;';
			hs+='visibility: inherit;';
			this._swf_38.setAttribute('style',hs);
			this.__div.appendChild(this._swf_38);
		}
	};
